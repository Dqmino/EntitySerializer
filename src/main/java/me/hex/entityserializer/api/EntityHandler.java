...
public class EntityHandler implements Serializer<Entity, NamespacedKey, EntityHolder> {

    private final StructureManager manager;
    private final StructureFactory factory;

    public EntityHandler(StructureManager manager, StructureFactory factory) {
     ...
     * @return deserialized EntityHolder from Name-spaced Key.
     */
    @Override
    public EntityHolder deserialize(NamespacedKey toDeserialize) {
        ...
        return new EntityHolder(structure);
    }
